...
import { CreateTransactionRuleDto, ListTransactionRuleQuery } from "../dto/transaction_rules.dto";
...
export class TransactionRuleController {
    ...
    // @Put(':id')
    // async update(@Param('id') id: string, @Body() data: CreateTransactionRuleDto) {
