...
export class TransactionController {
    ...
    async downloadTransactionTemplate(
        ...
        const buffer = await this.txnService.downloadTransactionTemplate(user);
        res.setHeader(
            'Content-Type',
    ...
    async downloadJournalVoucher(
        ...
        const bufferData = await this.txnService.downloadJournalVoucher(
            id,
            user,
        );
    ...
    async uploadExcel(
        ...
        return this.txnService.uploadExcel(file, user);
    }
    ...
    @Post('preview-lines')
    async preview(
        @Body() dto: PreviewTransactionLineDto,
        @CurrentUser() user: User,
    ) {
    ...
    @Get()
    async findAll(
        @Query() query: ListTransactionQuery,
        @CurrentUser() user: User,
    ) {
