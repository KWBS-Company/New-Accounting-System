...
export class InterestService {
    ...
    async interestCalculate(dto: InterestDto) {
        const { amount, loanTakenDate, compoundingDays, interestRateInPercentage } = dto;
        ...
        console.log('Loan taken days ', noOfDays);
        console.log('No of days in yr', noOfDaysInYear)
